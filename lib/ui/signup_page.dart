...
final formKey2 = GlobalKey<FormState>();
  ...
  TextEditingController signupUserRoleController = new TextEditingController();
  ...
  TextEditingController signupNameController1 = new TextEditingController();
  TextEditingController signupUserNameController1 = new TextEditingController();
  TextEditingController signupPasswordController1 = new TextEditingController();
  TextEditingController signupConfirmPasswordController1 =
      new TextEditingController();
      TextEditingController signupNumberController2 = new TextEditingController();
  TextEditingController signupNameController2 = new TextEditingController();
  TextEditingController signupUserNameController2 = new TextEditingController();
  TextEditingController signupPasswordController2 = new TextEditingController();
                  ...
                  child: Column(
                    children: <Widget>[
                     ...
                     /* Visibility(
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            top: 1.0, bottom: 15.0, left: 25.0, right: 25.0),
                        child: TextFormField(
                          controller: signupConfirmPasswordController,
                          obscureText: _obscureTextSignupConfirm,
                          validator:(value){
                            if(value !=signupPasswordController.text){return 'Password is not matching';}
                          },
                          style: TextStyle(
                              fontFamily: "WorkSansSemiBold",
                              fontSize: 16.0,
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          obscureText: _obscureTextSignupConfirm,
                          validator:(value){
                            if(value !=signupPasswordController1.text){return 'Password is not matching';}
                          },
                          style: TextStyle(
                              fontFamily: "WorkSansSemiBold",
                              fontSize: 16.0,
  ...
  key: _scaffoldKey2,
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          obscureText: _obscureTextSignupConfirm,
                          validator:(value){
                            if(value !=signupPasswordController2.text){return 'Password is not matching';}
                          },
                          style: TextStyle(
                              fontFamily: "WorkSansSemiBold",
                              fontSize: 16.0,
   ...
   void registerPostData(BuildContext context) async {
    ...
    dynamic bodyToSend = {'$role':true,'fullName':signupNameController.text,'userName':signupUserNameController.text,'phoneNumber':signupNumberController.text , 'password':signupPasswordController.text};
   ...
   void registerPostData1(BuildContext context) async {
    ...
    dynamic bodyToSend = {'isFreelancer':true,'fullName':signupNameController1.text,'userName':signupUserNameController1.text,'phoneNumber': signupNumberController1.text , 'password': signupPasswordController1.text,};
    dynamic headers = {'Content-Type': 'application/json'};
    var body = json.encode(bodyToSend);
    print(body);
    //request
   ...
   void registerPostData2(BuildContext context) async {
    ...
    dynamic bodyToSend = {'isHospital':true,'fullName':signupNameController2.text,'userName':signupUserNameController2.text,'phoneNumber': signupNumberController2.text , 'password': signupPasswordController2.text};
    dynamic headers = {'Content-Type': 'application/json'};
    var body = json.encode(bodyToSend);
    print(body);
    //request
